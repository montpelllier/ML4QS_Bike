...
# create our visualization class again.
...
label_columns = ['labelnormal', 'labelturnright', 'labelturnleft', 'labelbrake', 'labelstop', 'labelaccelerate']
train_X, test_X, train_y, test_y = prepare.split_single_dataset_classification(dataset, label_columns, 'like', 0.7,
...
basic_features = [
    'Acceleration x (m/s^2),Acceleration y (m/s^2),Acceleration z (m/s^2),Gyroscope x ('
...
time_features = [name for name in dataset.columns if 'temp' in name]
freq_features = [name for name in dataset.columns if (('freq' in name) or ('_pse' in name))]
print('#basic features: ', len(basic_features))
print('#PCA features: ', len(pca_features))
print('#time features: ', len(time_features))
print('#frequency features: ', len(freq_features))
cluster_features = [name for name in dataset.columns if 'total' in name]
...
print(features_after_chapter_3, features_after_chapter_4, features_after_chapter_5)
